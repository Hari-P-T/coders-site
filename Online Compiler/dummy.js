...
//                 const childProcess = exec(`./${compiledFileName}`, (runError, stdout, stderr) => {
//                     if (runError || stderr) {
//                         console.error('Run Error:', runError || stderr);
//                         res.status(400).send(`Run Error: ${runError || stderr}`);
//                     } else {
//                         res.status(200).send(stdout);
//                     }
//                 });

//                 // Pipe input from the request body to the child process stdin
...
//         }
//     });
//     fs.unlink(`./my-compiler/src/${compiledFileName}`, (err) => {
//         if (err) {
