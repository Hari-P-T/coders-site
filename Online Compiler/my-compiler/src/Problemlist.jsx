...
const ProblemList = () => {
    ...
    return (
        <div>
            <div className="container" style={{  width: "1200px", backgroundColor: "whitesmoke", marginTop: "50px", marginBottom: "50px", borderRadius: "20px" }}>
            ...
            <div className="container">
                <table className="table table-striped table-hover">
                    <thead>
                        <tr>
                            <th scope="col" style={{ height: "50px", color: "white", backgroundColor: "black" }}>#</th>
                            <th scope="col" style={{ height: "50px", color: "white", backgroundColor: "black" }}>Title</th>
                            <th scope="col" style={{ height: "50px", color: "white", backgroundColor: "black" }}>Difficulty</th>
                            <th scope="col" style={{ height: "50px", color: "white", backgroundColor: "black" }}>Status</th>
                        </tr>
                    </thead>
                    <tbody>
